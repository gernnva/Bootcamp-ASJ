...
public class VideoModel {
	...
	public VideoModel(Integer id, String url, String title, String description, int views, int likes, int dislikes,
			int qualificationQuantity, int totalQualification, CategoriaModel category) {
		this.id = id;
		this.url = url;
		this.title = title;
